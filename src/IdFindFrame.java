...
public class IdFindFrame extends JFrame {
	...
	IdFindFrame(Connection con) {//학번찾기 새로운창을 생성 생성된 창에 정보를 담는다.
		setResizable(false);
		setSize(320, 250);
		setVisible(true);
		...
		nameField = new JTextField();//이름 텍스트필드 생성
