...
public class InterestLectureAccessPage extends AccessPage {
	...
	private InterestLectureAccessPage	thisPage;					// this를 ButtonListener 안에서 넘겨주기 위함
	...
	public class ButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent event) {
			...
			if(obj == btnAccess) {	// 접속 버튼
				if(thisPage.getDtAccessStart().before(new Date()) && thisPage.getDtAccessEnd().after(new Date())) {	// 접속 가능 기간인 경우,
					primary.changeBody(primary.getInterestLecture());
