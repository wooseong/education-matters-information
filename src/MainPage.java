...
public class MainPage extends JPanel {
	...
	private class LoginListener implements ActionListener {
		public void actionPerformed(ActionEvent event) {
			...
			if(PW == null) {
				JOptionPane.showMessageDialog(btnLogin, "�뙣�뒪�썙�뱶瑜� �엯�젰�빐 二쇱꽭�슂");
			}
			else if(ID == null) {
				JOptionPane.showMessageDialog(btnLogin, "�븘�씠�뵒瑜� �엯�젰�빐 二쇱꽭�슂");
			}
			else {
				...
				try {
					if (db.getResultSet().next()) {
						...
						jtfID.setText("");
						jtfPW.setText("");
//						JOptionPane.showMessageDialog(btnLogin, "濡쒓렇�씤 �꽦怨�!");
					}
					else {
						JOptionPane.showMessageDialog(btnLogin, "�븰踰� �샊�� 鍮꾨�踰덊샇媛� ��由쎈땲�떎.");
					}
